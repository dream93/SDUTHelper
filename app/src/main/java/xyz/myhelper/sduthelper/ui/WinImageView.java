...
public class WinImageView extends ImageView {
    ...
    private static final String TAG = "WinImageView";
    ...
    public WinImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public WinImageView(Context context, AttributeSet attrs, int defStyle) {
            ...
            switch (msg.what) {
                ...
                case SCALING:
                    ...
                    if (count < 4) {
                        ...
                        isFinish = true;
                        if (WinImageView.this.mOnViewClickListener != null && !isClicked) {
                            isClicked = true;
                            WinImageView.this.mOnViewClickListener.onViewClick(WinImageView.this);
                        } else {
                            isClicked = false;
                        }
                    }
    ...
    public interface OnViewClickListener {
        void onViewClick(WinImageView view);
    }
